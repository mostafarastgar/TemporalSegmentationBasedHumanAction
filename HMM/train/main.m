...
% [windows, shifts] = break2WindowsFeaturePath(strcat(matDirPrefix, 'features/detail/'), windowSize, GMModel, minhog, maxhog, minhoof, maxhoof, coeff, pruneIndex, coeff2, pruneIndex2);
% for KTH is 'data/', for break fast is 'data/break fast/'
matDirPrefix='../data/break fast/';
