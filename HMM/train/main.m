...
[ videoVectors1, sequences1, prior1, transmat1, obsmat1, LL1, loglik1 ] = trainHMMGMM(data, 1, GMModel, coeff2, pruneIndex2);
...
[ videoVectors2, sequences2, prior2, transmat2, obsmat2, LL2, loglik2 ] = trainHMMGMM(data, 2, GMModel, coeff2, pruneIndex2);
...
[ videoVectors3, sequences3, prior3, transmat3, obsmat3, LL3, loglik3 ] = trainHMMGMM(data, 3, GMModel, coeff2, pruneIndex2);
...
[ videoVectors4, sequences4, prior4, transmat4, obsmat4, LL4, loglik4 ] = trainHMMGMM(data, 4, GMModel, coeff2, pruneIndex2);
...
[ videoVectors5, sequences5, prior5, transmat5, obsmat5, LL5, loglik5 ] = trainHMMGMM(data, 5, GMModel, coeff2, pruneIndex2);
...
[ videoVectors6, sequences6, prior6, transmat6, obsmat6, LL6, loglik6 ] = trainHMMGMM(data, 6, GMModel, coeff2, pruneIndex2);
