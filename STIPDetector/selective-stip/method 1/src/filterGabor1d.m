%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% @description: Creates an even/odd pair of 1D Gabor filters.
%
% @params :
...
function [feven,fodd] = filterGabor1d(r, sig, omega)
  ...
  inds = abs(feven) > 0.00001;
  feven(inds) = feven(inds) - mean(feven(inds));
  inds = abs(fodd) > 0.00001;
  fodd(inds) = fodd(inds) - mean(fodd(inds));
