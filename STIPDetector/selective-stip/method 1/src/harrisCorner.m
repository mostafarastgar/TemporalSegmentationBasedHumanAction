...
%           threshold : Threshold of the corner strength
%
% @output: corner_points : Coordinate of the corner point
%          cS : Corner strength
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [corner_points, cS] = harrisCorner(im, sigma_val, threshold)
  ...
  % Applying threshold on the conrener stregth to get the interest points
  cim(cim < threshold) = -1;
